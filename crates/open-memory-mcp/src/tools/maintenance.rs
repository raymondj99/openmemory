//! Maintenance tools — `open_memory_consolidate`.
//!
...
//! [`open_memory_graph::MemoryStore::consolidate`].

use schemars::JsonSchema;
use serde::Deserialize;
use serde_json::{json, Value};

use open_memory_graph::ConsolidateConfig;
...
mod tests {
    ...
    use open_memory_graph::{EntityType, MemoryStore, ObservationInput};
    use serde_json::json;
    ...
    #[test]
    fn descriptor_uses_open_memory_prefix() {
        let d = OpenMemoryConsolidateTool::descriptor();
        assert_eq!(d.name, "open_memory_consolidate");
