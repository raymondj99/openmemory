...
impl ConsolidateConfig {
    ...
    /// Apply [`open_memory_core::config::Config`] memory section values.
    #[must_use]
    pub fn from_config(cfg: &open_memory_core::config::Config) -> Self {
        Self {
...
mod tests {
    ...
    #[test]
    fn config_from_open_memory_config_round_trip() {
