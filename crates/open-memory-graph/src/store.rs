...
use open_memory_core::clock::{Clock, SystemClock};
use open_memory_core::config::Config;
use open_memory_index::engine::{open_engine, OpenEngine};
...
#[cfg(feature = "testing")]
use open_memory_core::testing::Embedder;
...
impl MemoryStore {
    ...
    /// a [`open_memory_core::testing::FakeEmbedder`] without taking a
...
mod tests {
    use super::*;
    use open_memory_core::clock::FixedClock;
